# Coalshift — Claude Code entry point

@docs/agent-instructions.md

Read the [quality profile](docs/quality.md) and, for the current state of the
code, [architecture](docs/architecture.md), [design-system](docs/design-system.md),
